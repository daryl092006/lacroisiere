...
const GALLERY_IMAGES = [
  ...
  { id: 3, src: "/exterior.png", category: "Espaces", span: "md:col-span-1 md:row-span-2", title: "Architecture Extérieure" },
  ...
  { id: 8, src: "/room.png", category: "Expérience", span: "md:col-span-2 md:row-span-1", title: "Confort Absolu" },
];
          ...
          <div className="flex flex-wrap justify-center gap-6 md:gap-12 border-b border-slate-200 pb-8">
            {CATEGORIES.map(cat => (
              <button 
                ...
                className={`text-[9px] font-black uppercase tracking-[0.3em] pb-3 transition-colors relative ${activeTab === cat ? 'text-[#233D8C]' : 'text-slate-400 hover:text-slate-900'}`}
              >
                {cat}
                {activeTab === cat && (
