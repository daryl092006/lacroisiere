            ...
            <form className="flex flex-col gap-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="Ex: Groupe Bolloré" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Secteur d'activité</label>
                  <input type="text" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="Ex: Logistique" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="John Doe" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Fonction</label>
                  <input type="text" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="DRH / Travel Manager" />
                </div>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="email" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="contact@entreprise.com" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Téléphone *</label>
                  <input type="tel" className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="+229 ..." />
                </div>
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-500">Besoins estimés</label>
                <textarea rows={3} className="border-b border-slate-200 py-3 focus:outline-none focus:border-[#233D8C] transition-colors bg-transparent resize-none placeholder:text-slate-300 placeholder:font-light placeholder:italic" placeholder="Ex: Hébergement pour 3 cadres expatriés pour une durée de 6 mois..." />
              </div>

              <button type="button" className="mt-4 bg-slate-900 text-white px-8 py-5 text-[10px] font-black uppercase tracking-[0.2em] rounded-sm hover:bg-[#233D8C] transition-colors flex items-center justify-center gap-4 shadow-lg w-full md:w-auto self-start">
